    ...
    <div class="scroll v-card-text">
        ...
        <div class="services-list">
            <div
                    ...
                    :key="i"
                    @click="toggleServiceChoose(service)"
                    class="services-list_row">
                <div class="doctor-info__services list" :class="(chosenServices[service.id]) ? 'chosen' : ''">
                    <div class="doctor-info__services_title serv-title">{{(service.title) ? service.title :  service.name}}
                        <span v-if="service.default_option" class="text-secondary text-no-wrap">{{ service.default_option }}</span>
                        <span v-else-if="service.option" class="text-secondary text-no-wrap">{{ service.option }}</span>
                        <div
                    ...
                    <div
                        ...
                        <div class="doctor-info__services_price_discount_price">
                            ...
                            <div class="doctor-info__services_price_current text-semibold d-inline">{{service.custom_price}}₽</div>
                        </div>
                    ...
                    <div v-else class="doctor-info__services_price serv-price">
                        <div class="doctor-info__services_price_current text-semibold">{{(service.price > service.custom_price) ? service.price : service.custom_price}}₽</div>
                    </div>
                    <div
                            v-if="(chosenServices[service.id])"
